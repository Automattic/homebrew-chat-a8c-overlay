...
def get_log_dir():
    ...
    log_dir = Path.home() / "Library" / "Logs" / "macos-a8c-chat-overlay"
...
LOG_DIR = get_log_dir()
LOG_PATH = LOG_DIR / "macos_a8c_chat_overlay_error_log.txt"
CRASH_COUNTER_FILE = LOG_DIR / "macos_a8c_chat_overlay_crash_counter.txt"
